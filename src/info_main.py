...
sas_info = info.info()
sas_info.add_info("Info 1", "test")
sas_info.add_info("Info 2", "test")
sas_info.add_info("Info 3", "test")
sas_info.add_info("Info 4", "test")
sas_info.add_info("Info 5", "test")
sas_info.add_info("Info 6", "test")
sas_info.add_info("Some Text", "Text")

#SVG

sas_info.add_svg("SVG 1", display_svg.draw_rect(0,0,100,100,"yellow", "green"), 200, 200)
sas_info.add_svg("SVG 2", display_svg.draw_circle(0,0,100,"yellow", "green"), 200, 200, "decription")
